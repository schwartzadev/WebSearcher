...
def extract_components(soup):
    ...
    # this is catching a 'please help us improve google' box
...
def parse_serp(serp, serp_id=None, verbose=False, make_soup=False, include_html=False):
    ...
    Args:
        ...
        include_html (bool, optional): Include the raw HTML of each component in the result
